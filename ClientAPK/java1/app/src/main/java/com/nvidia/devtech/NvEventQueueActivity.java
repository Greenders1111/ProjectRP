...
import com.byreytiz.game.gui.Electrictest;
...
public abstract class NvEventQueueActivity
    ...
    private Electrictest mElectrictest= null;
    ...
    public native void sendElectricClick(int electric11, int action);
...
public static void fixEditTextForAndroid10Xiaomi(EditText editText) {
    ...
    protected boolean systemInit()
    {
        ...
        mReg = new Reg(this);
        mElectrictest = new Electrictest(this);
    ...
    public void showElectrictest(int electric) { runOnUiThread(() -> { mElectrictest.show(electric); } ); }
