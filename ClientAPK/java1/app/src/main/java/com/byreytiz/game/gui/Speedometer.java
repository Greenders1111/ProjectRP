...
public class Speedometer {
    ...
    public Speedometer(Activity activity){
      ...
      //  mStrela2 = activity.findViewById(R.id.strela_pravo);
        ...
        leftButton = activity.findViewById(R.id.speedometr_turn_left);
        rightButton = activity.findViewById(R.id.speedometr_turn_right);
        leftButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                view.startAnimation(AnimationUtils.loadAnimation(activity, R.anim.button_click));
                try {
                    NvEventQueueActivity.getInstance().sendCommand("/ql".getBytes("windows-1251"));
        ...
        rightButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                view.startAnimation(AnimationUtils.loadAnimation(activity, R.anim.button_click));
                try {
                    NvEventQueueActivity.getInstance().sendCommand("/el".getBytes("windows-1251"));
                } catch (UnsupportedEncodingException e) {
                    throw new RuntimeException(e);
                }
            }
