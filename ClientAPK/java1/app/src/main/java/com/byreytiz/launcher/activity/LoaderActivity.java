...
import com.byreytiz.launcher.other.Utils;
...
public class LoaderActivity extends AppCompatActivity {
    ...
    public void startDownload() {
        ...
        String url = "https://www.dropbox.com/scl/fi/ayh27d96yc12hb1d2uuhz/black-cache.7z?rlkey=6vsbcomc261xxaprg8xt357pl&dl=1";
    ...
    public void afterDownload(){
    	Toast.makeText(this, "Игра успешно установлена!", Toast.LENGTH_SHORT).show();
         startActivity(new Intent(this, com.byreytiz.launcher.activity.MainActivity.class));
    }
}